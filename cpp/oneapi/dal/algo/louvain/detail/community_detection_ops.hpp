...
struct community_detection_ops_dispatcher {
    using task_t = typename Descriptor::task_t;
    community_detection_result<task_t> operator()(const Policy &policy,
                                       const Descriptor &descriptor,
                                       community_detection_input<Graph, task_t> &input) const {
...
struct community_detection_ops {
    using float_t = typename Descriptor::float_t;
    using task_t = typename Descriptor::task_t;
    using method_t = typename Descriptor::method_t;
    using allocator_t = typename Descriptor::allocator_t;
    using graph_t = Graph;
    using input_t = community_detection_input<graph_t, task_t>;
    using result_t = community_detection_result<task_t>;
    ...
    auto operator()(const Policy &policy, const Descriptor &desc, input_t &input) const {
        ...
        return community_detection_ops_dispatcher<Policy, Descriptor, Graph>()(policy, desc, input);
    }
};
